...
class Problem:
    ...
    def __init__(self, options=Options()):
        ...
        """Precision matrix of parameter estimates after the most recent iteration."""
        self._covariance_matrix = None
        """Covariance matrix of parameter estimates after the most recent iteration."""
    ...
    def solve(self):
        ...
        while not done_optimization:
            ...
            self._precision_matrix, _ = self._build_precision_and_information()
    ...
    def compute_covariance(self):
        ...
        try:
            self._covariance_matrix = splinalg.inv(
                self._precision_matrix).toarray()
    ...
    def _get_update_partition_dict(self):
        """Helper function to the full update vector."""
